        ...
        try:
            self.client = MongoClient(
                ...
                serverSelectionTimeoutMS=int(
                    os.environ.get("MONGODB_SERVER_SELECTION_TIMEOUT_MS", "2000")
                ),
            )
...
_mongodb_memory = None


def get_mongodb_memory() -> MongoDBMemory:
    """Return a lazily-created MongoDB memory instance."""
    global _mongodb_memory
    if _mongodb_memory is None:
        _mongodb_memory = MongoDBMemory()
    return _mongodb_memory
